...
docker run -p 1080:1323 -e "REDIS_HOST=172.17.0.1" ghcr.io/bootjp/vrc_panorama_picture_manage:latest
# print stdout
...
```bash
curl -X POST http://somehost:1080/api/update -H 'Content-Type: application/json' -d '{"key":"keystring", "token":"a4df3e9f-a6dc-4967-ac15-02750314f795", "URL":"https://avatars3.githubusercontent.com/u/1306365?v=4"}'
# save to content

# check for content redirect.
curl -v http://somehost:1080/r/keystring
